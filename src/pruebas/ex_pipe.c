/****************************************************************************/
/*	Programa " ls -l | wc > file.txt "                                      */
/*	El archivo file existe                                                  */
/*	Manejo errores                                                          */
/****************************************************************************/
...
int main(int argc, char* argv[])   
{
    ...
    {              
		...
		// Si execve tiene éxito, esta parte no se ejecutará
    ...
    { 
       ...
       {     
		  ...
		  char *wc_args[] = {"/usr/bin/wac", NULL};
          execve("/usr/bin/wac", wc_args, NULL);
